...
_ACTION_BY_CAUSE = {
    "brute force": ("block_ip", "high", "high",
    ...
    "data exfiltration": ("isolate_host", "urgent", "high",
    ...
    "beaconing": ("isolate_host", "urgent", "high",
...
_DEFAULT_ACTION = ("create_ticket", "medium", "medium",
...
def run_response_recommendation_agent(state: InvestigationState) -> InvestigationState:
    ...
    state.setdefault("agent_trace", []).append(
        {"agent_name": "response_recommendation", "status": "completed",
         "output": {"action": action_type, "priority": priority, "requires_human_approval": True}}
    )
    return state
